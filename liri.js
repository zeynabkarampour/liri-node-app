...
function retrieveTweets() {
    ...
    fs.appendFile('./log.txt', 'User Command: node liri.js my-tweet' + '\n\n', (err) => {})

    // Set up Search parameters (the 'screen_name' to my Twitter handle and the number of tweets that we want to retrieve)
    var params = {
        screen_name: 'Maryams90917342',
        count: 20
    };
...
function retrieveOBDBInfo(movie) {
    ...
    var queryStr = 'http://www.omdbapi.com/?t=' + search + '&plot=full&apikey=a2f98c62';
...
// doAsCmdTold will read in a file to determine the desired command and then execute
function doAsCmdTold() {
    // Append the command to the log file
